...
## 3. Parámetros seleccionados para esta prueba

| Parámetro | Valor |
|---|---|
| `platform` | `Facebook` |
| `account_id` | `1036844829507460` |
| `meta_post_id` | `1036844829507460_122151377199072582` |
| Referencia interna | `PUB-FB-17_30-44` |
| Asset | `Universe - Existencial 2607831.png` |
| `published_at_utc` | `2026-08-25T15:00:22Z` |
| Estado documentado | `is_published=true` |

Valores verificados en la evidencia raw del repositorio. Esta selección no autoriza la ejecución; solo fija el objetivo.
...
**Estado actual:** Diseñada, parámetros fijados, no autorizada para ejecución.
