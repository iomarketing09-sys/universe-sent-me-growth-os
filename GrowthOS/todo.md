...
- [ ] Evaluar los medios ya disponibles: USB de 28.8 GB y disco externo Windows con 730 GB libres. Confirmar de forma no destructiva el sistema de archivos, estado y carpeta segura disponible antes de asignar el respaldo.
