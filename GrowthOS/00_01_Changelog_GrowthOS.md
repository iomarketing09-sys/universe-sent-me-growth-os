...
- **[3.93.00] — 2026-08-24 (Manus): Borrador de aviso de privacidad preparado para Firma Bordados.** Se creó `Operations/Production/2026-08-24_Borrador_Aviso_Privacidad_Firma_Bordados.md` con propuestas de aviso integral y simplificado, basadas en Paty Lozano como responsable declarada, el domicilio confirmado y el correo de contacto del negocio. El documento señala como pendientes la denominación pública exacta, ARCO, conservación, URL final, proveedores y revisión legal; no se publicó en el sitio ni se activaron formulario, backend, proveedor, Turnstile, secreto, almacenamiento, analítica, Wix, DNS, nameservers ni dominio público.

- **[3.92.00] — 2026-08-25 (Fernando/Manus): Datos declarados para el futuro aviso de privacidad de Firma Bordados.** Fernando confirmó a Paty Lozano como persona responsable declarada y el domicilio operativo del negocio —Emilio Carranza #1021 Int. 113, Col. Burócratas, Piedras Negras, Coahuila— como referencia para el aviso. Los datos se registraron únicamente en el diseño interno de privacidad; falta confirmar la denominación pública exacta y el medio ARCO antes de publicar un aviso definitivo. No se activaron formulario, backend, proveedor, Turnstile, secreto, almacenamiento, analítica, Wix, DNS, nameservers ni dominio público.
