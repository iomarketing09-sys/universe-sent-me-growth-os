...
- Se reconciliaron los 39 históricos contra `Content_Inventory.csv` y Drive. Se localizaron 28 assets exactos en `05 Mayo`, 0 CNT confirmados y 0 CNT creados; los 11 top posts de junio-julio permanecen pendientes de evidencia de archivo. También se clasificaron lotes adicionales: 95 `Reserve`, 8 `Unmatched_Review`, 205 cruces Meta de mayo, 508 filas comparativas y 133 filas de inventario Drive. Informe y evidencia: `2026-08-17_Reconciliacion_Historicos_Individuales.md` / `.json`.
