# Calendario de Publicaciones: Viernes 1 y Sábado 2 de Agosto

**Propósito:** Plan operativo de publicaciones para el fin de semana (1 y 2 de agosto), aplicando la estrategia CGO, la regla de cascada y priorizando el uso de la Reuse Queue de mayo.
**Estado:** Active
**Fecha de creación:** 2026-08-01
**Última actualización:** 2026-08-01
**Versión:** 1.0
**Autor:** Manus AI (CGO)
**Documentos relacionados:** `04_00_Formato_Calendario_Semanal_CGO.md`, `Operations/Memories/reuse_queue_mayo_2026.csv`

---

## Viernes 1 de Agosto (Día de menor rendimiento: ~15K vistas)

El viernes es un día frío según los datos históricos, por lo que priorizamos contenido ligero, relatable y absurdo para mantener la frecuencia sin forzar la interacción profunda.
...
El sábado combina la frecuencia matutina/vespertina con el cierre de fin de semana. Aprovechamos para introducir contenido nuevo generado por Flow (las 3 proposals).

| Horario | Formato | Plataforma | Contenido (Fuente) | Personaje | Notas / Cascada |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **10:30 AM** | Foto (Meme) | FB | `260511.png` — *"Mi cerebro cuando alguien empieza una conversación normal"* (Relatable) | Universe | Reutilizado (Costo 0) |
...
1. **Memoria:** Se han consumido 7 memes de la `Reuse Queue` de mayo para este fin de semana.
2. **Contenido Nuevo:** Se introduce el meme de Universe (Dormir es para debiles) para el sábado a las 7:00 PM.
3. **Reels:** Los slots de las 7:00 PM del viernes y 9:00 PM del sábado requieren tu aprobación para asignar un video específico y activar la regla de cascada.
4. **Documentación:** Este plan se guarda en el repositorio como referencia operativa.
