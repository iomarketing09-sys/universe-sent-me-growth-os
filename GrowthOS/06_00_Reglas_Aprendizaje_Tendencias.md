...
La siguiente acción del orden recomendado es resolver la revisión humana de `FUT-MICRO-005`, `FUT-MICRO-006`, `FUT-TRANS-003` y `FUT-ACID-003`. Si se aprueban, pasarán a preflight; la aprobación no autoriza generación, calendario ni publicación. No se abrirá otra ronda histórica de captions ni se actualizará el ExperimentLog con estas etiquetas descriptivas.
