...
La matriz está en `Review`: assets, fechas, Meta IDs y aprobaciones permanecen en `TBD`/`Pending`. El plan no autoriza publicación ni modificación del calendario. Una familia solo puede pasar a una segunda ola después de contar con al menos tres casos comparables y una señal preliminar; no se deben declarar reglas universales a partir de una sola pieza o un outlier.
