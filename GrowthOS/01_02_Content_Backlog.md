...
### Prioridad Alta (Producción Inmediata / Reutilización)
...
| MPM-001 | Paseo forestal — motion POV | Figura de fantasía urbana + Wilfred | Reel vertical de 8s | `Asset_Ready` — MP4 9:16 disponible en Drive; falta definir copy, audio, posición canónica y paquete de programación. | Por revisar |
| MPM-002 | Fantasma y gatos — invernadero nocturno | Fantasma | Reel vertical candidato | `Reference_Ready` — imagen oficial 9:16 disponible; no generar sin una variación narrativa que lo diferencie de `Fantasma caminando con gatos` ya publicado. | No, con diferenciación editorial obligatoria |
...
| ID_Pieza | Título | Personaje Principal | Formato | Estado Actual | Bloqueado Canon |
| :--- | :--- | :--- | :--- | :--- | :--- |
| CNT-009 | Payaso — humor absurdo / Silvio | @char_USM_payaso | Reel / Meme / Frase | Idea | Sí (nombre Silvio) |
| CNT-010 | Ganso — contenido | @char_USM_ganso | Reel / Foto / Frase | Idea | No |
| CNT-011 | Kiri (Hada) — contenido mágico | @char_USM_hada | Reel / Foto | Idea | No |
| CNT-012 | Evan — contenido | @char_USM_evan | Reel / Foto | Idea | No |
| CNT-013 | Chica del Suéter — contenido emocional | @char_USM_chica_sweater | Reel / Foto | Idea | No |
