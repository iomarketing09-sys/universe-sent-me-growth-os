...
| `CNT-023` | `Resolved_Asset_Set` | La carpeta Drive `Elara - Lampara de luna` contiene 7 assets: `Cat_delivers_package_to_witch_202608081911.mp4`, `Cat_delivers_package_to_woman_202608081951.jpeg`, `Cat_walking_with_package_1080p_202608081939.mp4`, `Char_Elara_opening_package_202608081909.mp4` y tres renders `Generar_video_de_secuencia_imagenes_202608081917.mp4`, `...1922.mp4`, `...1928.mp4`. La publicación quedó confirmada en Meta como Page Post `1036844829507460_122147352825072582`, Reel `1067337609170026`, publicado el 08-Ago a las 19:19:54 hora local. |
| `CNT-029` | `Resolved_Project_Record` | Se recuperó y verificó la ficha de producción v2.1: banco de 9 cuadros, hook de pausa y estado Draft. La búsqueda acotada de Meta del 14–17 de agosto no encontró publicación coincidente. No se asigna `260` ni se crea fila de publicación. |
| `CNT-030` | `Resolved_Dependent_Record` | Se recuperó y verificó la ficha v2.0 de audio/montaje. Es dependiente de CNT-029, queda en Draft y la búsqueda acotada de Meta no encontró publicación independiente. Las pistas originales quedan como fallback documentado. |
