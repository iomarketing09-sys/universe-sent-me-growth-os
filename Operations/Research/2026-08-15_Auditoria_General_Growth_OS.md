...
| Comunidad | Primer lote de 9 comentarios registrado; 3 respuestas pendientes de aprobación y 1 riesgo escalado. Quedan deltas futuros y cobertura de respuesta. | P2 |
...
| P2 | La comunidad tiene comentarios, assets de respuesta y ahora un ledger operativo con su primer lote real; falta aprobar o rechazar las tres propuestas y medir cobertura en los siguientes deltas. | Media | Medio | Crear una tabla ligera de comentarios anonimizada y dos ventanas de revisión. |
