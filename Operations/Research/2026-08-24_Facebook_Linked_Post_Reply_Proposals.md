...
|---|---|---|---|
| `122151376083072582_1870186187563324` | yo  pero a veces hasta me da miedo quedar atorada como perros | Eso ya sería pasar de la química a la logística 😅 Mejor disfrutar la escena sin quedar atorados. | `Pendiente_Fernando` |
| `122151376083072582_1719326086024419` | No sabia que no podian todas jaja y la explicación que él me da jaja me da mucha risa como dice que le hago jajaj | Jajaja, ahí está el detalle: no todas las sorpresas vienen con manual de instrucciones 😅 | `Pendiente_Fernando` |
| `122151376083072582_1108096458452825` | Benditos los que tenemos eso en casa 🙏✨❤️‍🔥 | Jajaja, hay cosas que se disfrutan más cuando vienen con buen sentido del humor 😏 | `Pendiente_Fernando` |
| `122151376083072582_1028237043539692` | Yo juraba que era algo que TODAS hacíamos :0 | Jajaja, la escena dejó más de una teoría en el aire 😅 | `Pendiente_Fernando` |
| `122151376083072582_1976584486379301` | Que yo que? 😅😘 | Tú sabrás… nosotros solo estamos tomando nota 😏😂 | `Pendiente_Fernando` |
| `122151376083072582_1037906569213579` | Perrito 😂 cangrejo como sea somos afortunadas | El cangrejo también tiene su club de fans 😂 | `Pendiente_Fernando` |
| `122151376083072582_1387619540151231` | Así como yo viviré 120 años.🤗 | Con esa confianza, el universo ya te apartó lugar para los 120 🤗✨ | `Pendiente_Fernando` |
| `122151376083072582_2371700183567495` | Rikolino dijo bubulubu 😂 | Rikolino sabe lo que dice 😂 | `Pendiente_Fernando` |
| `122151376083072582_1620302366278351` | Jajaja todas pueden solo tiene que saber hacer los ejercicios | La clave está en saber hacerlo… y en no perder el sentido del humor 😂 | `Pendiente_Fernando` |
...
|---|---|---|---|
| `122151376083072582_2288087915279831` | CANGREJERA | Cangrejera oficial del universo 😂 | `Pendiente_Fernando` |
| `122151376083072582_1374303084841115` | 🤷🏼‍♀️ | Esa cara dice que el universo dejó más preguntas que respuestas 😅 | `Pendiente_Fernando` |
| `122151376083072582_2076744963209419` | Necesito!! | Jajaja, el universo recomienda ir con calma 😅 | `Pendiente_Fernando` |
