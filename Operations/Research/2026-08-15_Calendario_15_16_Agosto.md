...
**Propósito:** Mantener el calendario operativo del 15–16 de agosto y registrar sus publicaciones reales de Facebook e Instagram, conservando la aprobación manual y la separación entre plataformas.
**Estado:** Active
...
| 2026-08-16 | Domingo | 16:00 | Nueva | `2608036- Elara+Evan - Nadie nos soporta.jpeg` | Cuando hasta ustedes dos saben que son demasiado. 😅 #UniverseSentMe #ElaraUSM #EvanUSM | `PROGRAMADA` | Facebook; Instagram selectivo | Facebook programado; Meta confirmó publicación manual inmediata a las 15:05:30 hora local (`18342854773266069`), pero Fernando eliminó posteriormente la publicación; permalink histórico https://www.instagram.com/p/DcHY1W6libg/; sin `scheduled_publish_time`; no cuenta como publicación activa; original en `08 Agosto`, sin copia. |
| 2026-08-16 | Domingo | 19:00 | Nueva | `2608060 - Kael+Maeve - gustos salvajones.jpeg` | No tenemos gustos raros, tenemos gustos salvajones. 😏 #UniverseSentMe #MaeveUSM #MemesUSM | `PROGRAMADA` | Facebook; Instagram selectivo | Facebook programado; el intento histórico de Instagram fue eliminado manualmente (`17922210816414183`, https://www.instagram.com/p/DcHY26jGpM8/), pero la republicación autorizada está activa con media `17909839698449207`, permalink https://www.instagram.com/p/DcHxv5SlorV/ y hora real 18:43:17; sin `scheduled_publish_time`; original en `08 Agosto`, sin copia. |
...
Para el lote actual, `2608030 - Universe - Que fibra tomas pa cagarla tanto.jpeg` permanece publicada en Instagram. Después, Fernando autorizó explícitamente republicar `2608036` y `2608060` aunque sus intentos anteriores habían sido eliminados manualmente. Las dos republicaciones nuevas fueron confirmadas por Meta y están activas: `2608036` con media `17891183814416135` y permalink https://www.instagram.com/p/DcHxuuWllRk/; `2608060` con media `17909839698449207` y permalink https://www.instagram.com/p/DcHxv5SlorV/. `260583` sigue prohibida y no se autorizan otras filas sin aprobación explícita.

## Registro de ejecución

La programación de Facebook se ejecutó mediante Graph API usando el Page Access Token derivado desde `/me/accounts`. Meta devolvió `is_published: false` y `scheduled_publish_time` para los nueve posts. En Instagram, `2608030` permanece activo y las republicaciones nuevas de `2608036` y `2608060` fueron confirmadas mediante `/{IG_ID}/media`, verificación `status_code=FINISHED` y `/{IG_ID}/media_publish`. Sus intentos históricos eliminados se conservan en los ledgers como trazabilidad separada. `260583` fue publicado previamente como prueba controlada y eliminado manualmente; queda prohibido como destino de republicación.

## Reglas de ejecución

La aprobación de Fernando quedó recibida antes de la ejecución de Facebook. Las nueve órdenes de Facebook fueron creadas; Instagram permanece como distribución selectiva y manual. La tarea programada de Instagram fue desactivada porque no garantizaba la coincidencia entre despertar y ventana de publicación. Cada fila de Instagram requiere aprobación explícita. `2608036` y `2608060` tienen ahora una republicación activa adicional, separada de sus intentos históricos eliminados; `2608030` no se duplicó. El calendario del 17–30 de agosto no fue alterado. `260583` fue eliminada manualmente y no debe republicarse.
