...
root=Path('/home/ubuntu/universe-sent-me-growth-os'); src=root/'Operations/Research/June_Sexualidad_Alto_Rendimiento_Images'; out=root/'Operations/Research/June_Sexualidad_Alto_Rendimiento_ContactSheets'; out.mkdir(exist_ok=True)
...
for start in range(0,len(files),4):
 ...
 p=out/f'sexual_visual_review_contact_{start//4+1}.jpg'; sheet.save(p,quality=92); print(p)
