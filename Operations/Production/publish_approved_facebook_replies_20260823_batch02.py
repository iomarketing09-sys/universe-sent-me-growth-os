#!/usr/bin/env python3
"""Publish and verify the explicitly approved six-comment Facebook batch."""
...
OUT_PATH = ROOT / "Operations/Research/2026-08-23_Facebook_Comment_Publication_Batch_02.json"
TARGET_IDS = [
    "122151376083072582_1078572578055585",
    "122151376011072582_1374323618238603",
    "122151376011072582_1474344638049134",
    "122151376011072582_2991082287899276",
    "122151376011072582_2308975296571861",
    "122151375549072582_1089305796872950",
]
...
for target_id in TARGET_IDS:
    ...
    preflight_response, preflight_payload = api(
        session,
        "GET",
    ...
    exact = next(
        (reply for reply in preflight_payload.get("data", [])
         if author_name(reply) == "Universe Sent Me" and reply.get("message") == message),
        None,
    )
    if exact:
