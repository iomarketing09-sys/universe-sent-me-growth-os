...
| Tiempo | Shot | Acción visual | Audio / diálogo |
| :--- | :--- | :--- | :--- |
| 00-03s | Gancho | Universe (gato con lentes) aparece junto al fogón de Elara arrastrando un paquete de Mercado Libre. Nadie esperaba un gato repartiendo paquetes. | Ambiente de bosque místico + música de intriga suave. |
| 03-08s | La entrega | Universe deja el paquete frente a Elara, le da un toquecito con la pata y se sienta a observar, sin abrir nada. | **Texto en pantalla (Universe):** "Esto llegó para ti. No sé qué es. Nunca sé qué es." |
...
>
> 👇 Escribe "AROMA" en los comentarios y te llega el link directo al difusor que le llegó a ella.
>
> #UniverseSentMe #QueMeLlegoUSM #UniverseUSM #ElaraUSM
