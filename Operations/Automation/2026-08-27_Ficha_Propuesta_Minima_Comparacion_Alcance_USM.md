...
El procedimiento preliminar `2026-08-27_Procedimiento_Preliminar_Propuesta_Minima_GSEC2_4c_USM.md` v1.3 fue revisado de manera humana independiente y está en `Review`. El gate `2026-08-27_Gate_Diseno_Propuesta_Hipotetica_Unica_GSEC2_4cP1_USM.md` v1.1 también fue revisado y está en `Review`; delimita una futura propuesta hipotética sin crearla. No se deben copiar ni completar esta ficha, emitir una tarjeta, solicitar consentimiento, abrir datos o rutas privadas, invocar collectors, OAuth/API, ledger, cron, Docker, OmniRoute, Drive, Sheets, GitHub como destino de datos, IA o salidas externas. Cualquier continuación exige una autorización nueva para diseñar un gate sobre el formato vacío de una propuesta hipotética.
