"""Sync verified batch 08 replies into the community ledger."""
...
BATCH = ROOT / "Operations/Research/2026-08-24_Facebook_Comment_Publication_Batch_08.json"
LEDGER = ROOT / "Operations/Research/2026-08-15_Community_Engagement_Log.csv"
OUT = ROOT / "Operations/Research/2026-08-24_Facebook_Comment_Publication_Record_Batch_08.json"

batch = json.loads(BATCH.read_text(encoding="utf-8"))
if batch.get("requested_count") != 2 or batch.get("verified_count") != 2:
    raise SystemExit("BATCH_NOT_EXACTLY_TWO_VERIFIED")
...
payload = {
    "title": "Facebook Comment Publication Record Batch 08",
    "purpose": "Registrar la sincronización de las dos respuestas aprobadas y verificadas en el Community Engagement Log.",
    "status": "Active",
