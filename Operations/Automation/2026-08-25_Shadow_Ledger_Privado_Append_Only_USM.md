...
G-SEC-2 pasó a `Review` después de la confirmación humana de los cuatro límites de diseño. G-SEC-2.3a pasó con un fixture ficticio: rechazó destinos externos, scheduling, datos privados, red, monetización y otras marcas, mientras permitió solo una comprobación manual en memoria y bloqueó la apertura de sockets. Las pruebas separadas G-SEC-2.1a de minimización/egress y G-SEC-2.2a de retención/disposición también pasaron con fixtures ficticios y guardia de socket. La primera rechazó campos no mínimos, raw, destinos externos y marcas ajenas; la segunda rechazó vencimiento sin revisión, eliminación/re-escritura automática, archivo externo y retención indefinida. G-SEC-2.4a también pasó con una tarjeta ficticia completa y ocho rechazos de completitud, alcance, retención, operación, egress, vigencia/revocación y datos simulados. La plantilla vacía y el procedimiento de solicitud humana están documentados en `2026-08-27_Plantilla_Tarjeta_Consentimiento_Puntual_USM.md` v1.7 y su revisión humana fue confirmada; permanece vacía y no es una tarjeta emitida. La ficha pública vacía y lista de comparación de alcance se documentan en `2026-08-27_Ficha_Propuesta_Minima_Comparacion_Alcance_USM.md` v1.3 y permanecen en `Draft`. G-SEC-2.5 pasó la revisión estática pública de coherencia entre las tres piezas tras una corrección textual de fixture, sin ampliar alcance. G-SEC-2.6 ahora documenta la matriz final de consolidación pública y su revisión de diseño fue confirmada; está en `Review`, pero no ejecuta la matriz ni modifica este contrato. Antes de cualquier G-NORM-4R, falta revisar la ficha, consolidar la documentación mediante autorización separada, una tarjeta real completa y un gate separado de consentimiento puntual; ningún PASS sintético ni revisión documental los sustituye. No se abrirán tokens, evidencia, collectors, API, cron, Docker, OmniRoute, Sheets, Drive, GitHub ni modelos como consecuencia de esta dependencia.
