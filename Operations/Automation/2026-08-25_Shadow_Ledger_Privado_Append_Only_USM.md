...
G-SEC-2 pasó a `Review` después de la confirmación humana de los cuatro límites de diseño. G-SEC-2.3a pasó con un fixture ficticio: rechazó destinos externos, scheduling, datos privados, red, monetización y otras marcas, mientras permitió solo una comprobación manual en memoria y bloqueó la apertura de sockets. Las pruebas separadas G-SEC-2.1a de minimización/egress y G-SEC-2.2a de retención/disposición también pasaron con fixtures ficticios y guardia de socket. La primera rechazó campos no mínimos, raw, destinos externos y marcas ajenas; la segunda rechazó vencimiento sin revisión, eliminación/re-escritura automática, archivo externo y retención indefinida. G-SEC-2.4a también pasó con una tarjeta ficticia completa y ocho rechazos de completitud, alcance, retención, operación, egress, vigencia/revocación y datos simulados. El diseño no modifica este contrato ni habilita su escritor real. Antes de cualquier G-NORM-4R, todavía debe diseñarse una tarjeta puntual real y una solicitud humana con alcance técnico exacto; ningún PASS sintético los sustituye. No se abrirán tokens, evidencia, collectors, API, cron, Docker, OmniRoute, Sheets, Drive, GitHub ni modelos como consecuencia de esta dependencia.
