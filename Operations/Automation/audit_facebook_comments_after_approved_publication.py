"""Read-only Facebook comment scan after the latest approved publication.
...
new/unanswered candidates after the latest verified approved-publication cursor.
"""
...
BATCH14 = ROOT / "Operations/Research/2026-08-24_Facebook_Comment_Publication_After_Batch14.json"
OUT = ROOT / "Operations/Research/2026-08-24_Facebook_Comment_Review_After_Approved_Publication.json"
POST_LIMIT = 20
MAX_WORKERS = 8
TIMEOUT = 30
...
result = {
    ...
    "purpose": "Revisión de solo lectura de comentarios nuevos y oportunidades potenciales de engagement después de la última publicación aprobada, incluyendo raíces y réplicas de las 20 publicaciones propias más recientes.",
    "status": "Review",
    ...
    "cursor_source": "Operations/Research/2026-08-24_Facebook_Comment_Publication_After_Batch14.json",
