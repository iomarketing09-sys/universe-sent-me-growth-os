...
El diseño separado `2026-08-25_Consentimiento_Piloto_Real_Shadow_Ledger_USM.md` v2.3 materializa esos controles como G-SEC-2. La condición de cifrado local se mantiene cumplida, pero no basta para habilitar tratamiento: G-SEC-2 está en `Review` tras confirmación humana de los cuatro límites. Su primer subgate técnico, G-SEC-2.3a, pasó con fixture y validador sintéticos, rechazo de egress/scheduler/datos privados/red/finanzas/marcas ajenas y guardia de socket bloqueada. Faltan pruebas sintéticas separadas de privacidad/minimización y retención; no existe consentimiento vigente ni autorización de operación real. Por tanto, G-NORM-4R continúa bloqueado.
