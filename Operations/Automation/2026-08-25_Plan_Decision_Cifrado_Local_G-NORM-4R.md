...
G-MIG-LUKS-1.7 ya restauró selectivamente las rutas autorizadas dentro del sistema cifrado, conservando el repositorio GitHub canónico y sin activar OmniRoute, collectors ni automatizaciones. La condición previa de almacenamiento local cifrado y recuperación controlada queda cumplida; no obstante, G-NORM-4R sigue bloqueado hasta G-MIG-LUKS-1.8, la reinstalación/prueba sintética de herramientas, y la renovación posterior de los gates de privacidad, retención, operación read-only y consentimiento granular.
