...
lines = [
    ...
    f"| Propuestas pendientes de aprobación | {review['proposal_count']} |",
    f"| Casos sin acción | {review['no_action_count']} |",
    f"| Publicaciones realizadas | {review['publication_count']} |",
    f"| Filas del ledger después del registro | {review['ledger_rows_after_registration']} |",
    "",
    "## Resumen ejecutivo",
    "",
    f"Meta Graph API v26.0 encontró **{review['candidate_count']} comentarios nuevos sin respuesta** desde el cursor del Batch 14. Se prepararon **{review['proposal_count']} propuestas específicas** para aprobación de Fernando y se clasificaron **{review['no_action_count']} casos como `No_Requiere_Respuesta`**. La mayoría de los casos sin acción son réplicas dentro de conversaciones usuario-a-usuario, comentarios de baja señal o contenido sexual que no debe escalarse desde la Página.",
    "",
...
lines += ["", "## Propuestas pendientes de aprobación", "", "Estas propuestas están registradas como `Pendiente_Respuesta` y **no deben publicarse sin autorización explícita**.", "", "| # | Comentario | Publicación | Propuesta USM | Prioridad | Criterio |", "|---:|---|---|---|---|---|"]
for index, r in enumerate(proposals, 1):
