"""Read-only Facebook comment scan after the latest five approved replies.
...
new/unanswered candidates after the latest verified five-reply publication cursor.
"""
...
LATEST_PUBLICATION = ROOT / "Operations/Research/2026-08-24_Facebook_Comment_Publication_After_Approved_Publication_Review.json"
OUT = ROOT / "Operations/Research/2026-08-25_Facebook_Comment_Review_After_Five_Approved_Replies.json"
POST_LIMIT = 20
MAX_WORKERS = 8
TIMEOUT = 30
...
latest_publication = json.loads(LATEST_PUBLICATION.read_text(encoding="utf-8"))
cursor = parse_dt(latest_publication["published_at"])
...
result = {
    ...
    "purpose": "Revisión de solo lectura de comentarios nuevos y oportunidades potenciales de engagement después de las cinco últimas respuestas aprobadas, incluyendo raíces y réplicas de las 20 publicaciones propias más recientes.",
    "status": "Review",
    ...
    "cursor_source": "Operations/Research/2026-08-24_Facebook_Comment_Publication_After_Approved_Publication_Review.json",
    "cursor": latest_publication["published_at"],
    "page_id": PAGE_ID,
